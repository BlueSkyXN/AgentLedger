...
这些文档描述的是当前 Go CLI 已实现能力，而不是早期长期完整账本设计。当前 CLI 没有 cleanup/restore/pricing/workspace 命令；成本估算、currency 报表转换、加密 raw archive 和完整 source file tracking 都属于后续能力。
